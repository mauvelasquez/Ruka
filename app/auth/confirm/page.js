    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#F8F4EE' }}>
      <div className="w-full max-w-md text-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-10">
          ...
          <h1 className="text-2xl font-black text-gray-900 mb-3">¡Casi listo!</h1>
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            Te enviamos un email de confirmación. Revisa tu bandeja de entrada y haz clic en el enlace para activar tu cuenta.
          </p>
