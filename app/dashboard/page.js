      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/perfil"
              className="bg-white text-gray-600 border border-gray-200 hover:border-forest hover:text-forest px-4 py-2.5 rounded-xl font-bold text-sm transition-colors flex items-center gap-2">
