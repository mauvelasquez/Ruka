...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    ...
    // Chile-focus: ocultar hogares demo de AR/CO/MX en la carga pública directa,
    // igual que /api/homes (route.js usa .or('is_demo.is.null,is_demo.is.false,country_code.eq.CL'))
    const PUBLIC_FILTERS = {
      homes: 'or=(is_demo.is.null,is_demo.is.false,country_code.eq.CL)',
    }
