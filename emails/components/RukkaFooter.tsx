  ...
  return (
    <Section style={{ backgroundColor: '#F5F0E8', padding: '24px', textAlign: 'center' }}>
      ...
      <Text style={{ margin: '0 0 8px', fontSize: '12px', color: '#888888', fontFamily: 'system-ui, sans-serif' }}>
        {'📸 '}
        <Link href="https://instagram.com/rukka_latam" style={{ color: '#1B4F72', textDecoration: 'none' }}>
          Instagram @rukka_latam
        </Link>
        {'   🎵 '}
        <Link href="https://tiktok.com/@rukka_latam" style={{ color: '#1B4F72', textDecoration: 'none' }}>
          TikTok @rukka_latam
        </Link>
      </Text>
      <Text style={{ margin: '0 0 8px', fontSize: '12px', color: '#888888', fontFamily: 'system-ui, sans-serif' }}>
